...
```sh
mix usage_rules.search_docs "search term" -p ash -p ash_admin -p ash_authentication -p ash_authentication_phoenix -p ash_phoenix -p ash_sqlite -p ash_state_machine
```
