...
config :ytdarr, YtdarrWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: YtdarrWeb.ErrorHTML, json: YtdarrWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ytdarr.PubSub,
  live_view: [signing_salt: "sK655v0N"]
...
config :ytdarr, Ytdarr.Mailer, adapter: Swoosh.Adapters.Local
