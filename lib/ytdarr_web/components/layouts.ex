defmodule YtdarrWeb.Layouts do
  ...
  attr :modal_open?, :boolean,
    default: false,
    doc: "true while a modal is open; makes the rest of the app shell inert"

  slot :modal, doc: "an optional modal rendered as a sibling of the inert app shell"

  def app(assigns) do
    ~H"""
    <div id="app-shell" inert={@modal_open?} aria-hidden={@modal_open? && "true"}>
