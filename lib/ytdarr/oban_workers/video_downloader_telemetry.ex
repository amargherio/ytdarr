defmodule Ytdarr.ObanWorkers.VideoDownloaderTelemetry do
  ...
  defp handle_failure(_measurements, %{worker: Ytdarr.ObanWorkers.VideoDownloader, args: %{"video_id" => video_id}}) do
  ...
  defp reset_video_state(video_id) do
    Logger.info("VideoDownloader job failed/cancelled/discarded for video #{video_id}. Resetting state.")
